...
# judul
judul = tk.Label(root, text="Face Id - Absensi Siswa", font=("Roboto",34),bg="#242526", fg="white")
canvas.create_window(350, 80, window=judul)
#credit
made = tk.Label(root, text="Selamat Datang", font=("Times New Roman",13), bg="black",fg="white")
...
intructions = tk.Label(root, text="By Ouzhika", font=("Roboto",15),fg="white",bg="black")
...
Rekam_btn2 = tk.Button(root, textvariable=Rekam_text2, font="Roboto", bg="#20bebe", fg="white", height=1, width=10, command=absensiWajah)
Rekam_text2.set("Mulai")
